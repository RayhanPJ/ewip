                    ...
                    <div class="col-12 col-xl-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h4 class="box-title">Check Data Timah</h4>
                                <?php $array_bundle = array_values($itemCounts); ?>
                            </div>
                            <div class="row mt-3">
                            ...
                            <div class="row mt-4">
                                <div class="col-12 col-xl-12">
                                    <div class="box-header with-border">
                                        <form id="rack-form" action="<?= base_url() ?>STO_timah/inputData" method="post">
                            ...
                            <div class="row mt-3">
                                <div class="col-6">
                                    <div class="box-body">
                                        <h4 class="text-center">Table Summary Items</h4>
                                        <div class="table-responsive">
                                            <!-- DataTables functionality is initialized with .js-dataTable-full class in js/pages/be_tables_datatables.min.js which was auto compiled from _es6/pages/be_tables_datatables.js -->
                                            <table class="table table-bordered table-striped table-vcenter js-dataTable-full" id="data_summary">
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody>
                                                    <?php
                                                    $count = 1;
                                                    $totalAllItems = 0; // Menyimpan total gabungan semua $totalQty
                                                    $itemCounts = []; // Menyimpan jumlah item berdasarkan kunci
                                                    foreach ($summary as $items => $totalQty) {
                                                        $totalAllItems += $totalQty;
                                                    ?>
                                                        <tr>
                                                            <td class="text-center"><?php echo $count; ?></td>
                                                            <td><?php echo $items ?></td>
                                                            <td><?php echo $array_bundle[$count - 1] ?></td>
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        <th colspan="2" class="text-center">TOTAL QTY ALL ITEMS</th>
                                                        <td><?php echo array_sum($array_bundle); ?></td>
                                                        <td><?php echo $totalAllItems; ?></td>
                                                    </tr>
                                                </tfoot>
                                            </table>
                                        </div>
                            ...
                            <div class="row mt-3">
                                <div class="col">
                                    <div class="box-body">
                                        <h4 class="text-center">Table Items</h4>
                                        <div class="table-responsive">
                                            <!-- DataTables functionality is initialized with .js-dataTable-full class in js/pages/be_tables_datatables.min.js which was auto compiled from _es6/pages/be_tables_datatables.js -->
                                            <table class="table table-bordered table-striped table-vcenter js-dataTable-full" id="data_item">
                                                <thead>
                                                    <tr>
                                                        <th class="text-center">NO</th>
                                                        <th>BARCODE</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($datas as $items) { ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $items->cwarf ?></td>
                                                            <td><?php echo $items->no_dn ?></td>
...
<script type="text/javascript">
    ...
    const dataModel = <?= json_encode($datas) ?>;
    ...
    function updateTableData(data) {
        ...
        if (data.length == 0) {
            ...
            dataModel.forEach(function(itemModel) {
                data.forEach(function(itemData) {
                    if (itemModel.barc === itemData.barc) {
                        check = true;
                    }
                });
            });
        ...
        if (check == true) {
            dataModel.forEach(function(row) {
                if (input.value == row.barc) {
                    const newRow = document.createElement('tr');
                    // newRow.setAttribute('class', 'border border-success');
    ...
    input.addEventListener('change', function(event) {
        ...
        const url = "https://portal2.incoe.astra.co.id/e-wip-infor/api/getDataScan/" + content;
        sendGetRequest(url);
    });
    ...
    submitButton.addEventListener('click', function(event) {
        ...
        const xhr = new XMLHttpRequest();
        xhr.open('POST', 'base_url()/Sto_timah/inputData', true);
