...
<div class="content">
    <!-- Bootstrap Design -->
    <h2 class="content-heading">Form Transaksi Produksi - <?php echo $this->session->userdata('username'); ?></h2>
        ...
        <div class="col-md-12">
            ...
            <div class="block">
                <div class="block-content">
                    <form action="<?php echo base_url('whkom/update_produksi_scan') ?>" method="post" enctype="multipart/form-data">
                        ...
                        <tbody>
                            <?php $count=1; foreach ($data as $d) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($d->generate_baan == 0 AND $d->status_whkom == 3) { ?>
