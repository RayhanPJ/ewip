...
<script>
    ...
    function filterByDate() {
        ...
        window.location.replace('<?=base_url(); ?>order_lead_part/activity_supply/'+tanggal);
    }

    function filterByDelivery() {
        var tanggal = $('#filterTanggal').val()
        var sesi = $('#filter_delivery').val()
        window.location.replace('<?=base_url(); ?>order_lead_part/activity_supply/'+tanggal+'/'+sesi);
    }

    function linkPage(i) {
        var tanggal = $('#filterTanggal').val()
        var sesi = $('#filter_delivery').val()
        window.location.replace('<?=base_url(); ?>order_lead_part/activity_supply/'+tanggal+'/'+sesi+'/'+i);
    }
