...
<?php foreach ($data as $d) { ?>
    <div style="text-align: center;"  class="content">
        ...
        <p><?php echo $d->item; ?></p>
        <!-- <br> -->
        <h1 class="content-heading">QTY : <?php echo $d->actq; ?> Kg</h1>
        <p>*****************************************************</p>
        ...
        <p>*****************************************************</p>
        <br>
        <!-- <img height="100" width="100"src="<?php echo base_url('assets/img_qr/'.$d->qr_code);?>" alt="QR Code"> -->
        ...
        <br>
        <a class="btn btn-success" href="<?php echo base_url('whfg_timah/getDataDnAdj/'.$d->no_dn) ?>">Back</a>
    </div>
<?php } ?>
<!-- END Page Content -->
</body>