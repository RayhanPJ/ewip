...
<div class="content">
    <!-- Bootstrap Design -->
    <h2 class="content-heading">Form Transaksi Charging - <?php echo $this->session->userdata('username'); ?></h2>
    <a class="btn btn-alt-primary" href="<?php echo base_url('whfg/chg_scan') ?>"><i class="fa fa-plus mr-5"></i>Refresh</a>
        ...
        <div class="col-md-12">
            ...
            <div class="block">
                <div class="block-content">
                    <form action="<?php echo base_url('whfg/wtaBarcodeChg') ?>" method="post" enctype="multipart/form-data">
