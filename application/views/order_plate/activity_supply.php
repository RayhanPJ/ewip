                    ...
                    <form action="<?=base_url()?>order_plate/confirmSupply" method="POST">
                        <table class="table-supply-plate" style="margin: 0 auto;">
                            <tr>
                                <td>Jenis Plate</td>
                                <td> : </td>
                                <td><?=$data[$count]['jenis_plate']?></td>
                            </tr>
                            <tr>
                                <td>Type Plate</td>
                                <td> : </td>
                                <td><?=$data[$count]['type_plate']?></td>
                            </tr>
                            <tr>
                                <td>Jumlah Pnl</td>
                                <td> : </td>
...
<script>
    ...
    function filterByDate() {
        ...
        window.location.replace('<?=base_url(); ?>order_plate/activity_supply/'+tanggal);
    }

    function filterByDelivery() {
        var tanggal = $('#filterTanggal').val()
        var sesi = $('#filter_delivery').val()
        window.location.replace('<?=base_url(); ?>order_plate/activity_supply/'+tanggal+'/'+sesi);
    }

    function linkPage(i) {
        var tanggal = $('#filterTanggal').val()
        var sesi = $('#filter_delivery').val()
        window.location.replace('<?=base_url(); ?>order_plate/activity_supply/'+tanggal+'/'+sesi+'/'+i);
    }
