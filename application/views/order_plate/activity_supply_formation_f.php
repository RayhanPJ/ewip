                ...
                <?php
                    ...
                    <form action="<?=base_url()?>order_plate/confirmSupply" method="POST">
                        <table class="table-supply-plate" style="margin: 0 auto;">
                            ...
                            <tr>
                                <td style="vertical-align:top">QR Code <button type="button" class="btn btn-primary" onclick="add_barcode()" <?= $data[$count]['status_supply'] != 'Open' ? 'disabled' : '' ?>><i class="fa fa-plus"></i></button></td>
                        ...
                        <div class="row">
                            <div class="col-4" style="text-align:left;">
                                <input type="hidden" name="gedung" value="formation">
...
<script>
    ...
    function filterByDate() {
        ...
        window.location.replace('<?=base_url(); ?>order_plate/activity_supply_formation_f/'+tanggal);
    }

    function filterByDelivery() {
        var tanggal = $('#filterTanggal').val()
        var sesi = $('#filter_delivery').val()
        window.location.replace('<?=base_url(); ?>order_plate/activity_supply_formation_f/'+tanggal+'/'+sesi);
    }

    function linkPage(i) {
        var tanggal = $('#filterTanggal').val()
        var sesi = $('#filter_delivery').val()
        window.location.replace('<?=base_url(); ?>order_plate/activity_supply_formation_f/'+tanggal+'/'+sesi+'/'+i);
    }
