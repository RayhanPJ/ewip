...
<script>
    ...
    function filterByDate() {
        ...
        window.location.replace('<?=base_url(); ?>order_plate/activity_supply_formation/'+tanggal);
    }

    function filterByDelivery() {
        var tanggal = $('#filterTanggal').val()
        var sesi = $('#filter_delivery').val()
        window.location.replace('<?=base_url(); ?>order_plate/activity_supply_formation/'+tanggal+'/'+sesi);
    }

    function linkPage(i) {
        var tanggal = $('#filterTanggal').val()
        var sesi = $('#filter_delivery').val()
        window.location.replace('<?=base_url(); ?>order_plate/activity_supply_formation/'+tanggal+'/'+sesi+'/'+i);
    }
